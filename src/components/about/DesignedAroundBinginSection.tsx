  ...
  return (
    <section className="w-full bg-white px-4 py-10 sm:px-6 lg:px-10">
      <div className="flex flex-col gap-6 lg:min-h-[900px] lg:flex-row lg:gap-6 items-stretch">
        ...
        <div className="order-1 flex flex-1 flex-col justify-start lg:order-1 lg:min-w-0 xl:w-full">
        ...
        <div className="order-2 w-full shrink-0 lg:order-2 lg:w-[672px] xl:flex-1 xl:min-w-0 xl:w-full">
